...
def _smacof_single(dissimilarities, metric=True, n_components=2, init=None,
    ...
    # add weight here
    # weights = 1/dissimilarities/dissimilarities
    V = -weights
    ...
    for it in range(max_iter):
        ...
        # Compute stress
        stress = np.nansum(weights.ravel() * ((dis.ravel() - disparities.ravel()) ** 2)) / 2
...
def smacof(dissimilarities, metric=True, n_components=2, init=None, n_init=8,
           ...
           return_n_iter=False,weights=None):
...
class relativeMDS(BaseEstimator):
    ...
    def fit(self, X,weights = None, y=None, init=None):
        """
        ...
        init : ndarray, shape (n_samples,), optional, default: None
            ...
            chosen array.
        """
        self.fit_transform(X, weights, init=init)
        return self

    def fit_transform(self, X, weights = None, y=None, init=None):
        """
